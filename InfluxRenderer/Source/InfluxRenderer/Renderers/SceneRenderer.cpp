...
#pragma endregion
	...
	void SceneRenderer::OnBuildRenderCommandList(const Renderer::RenderContext& context, Graphics::RHICommandList* cmdList)
	{
		...
		Graphics::RHIViewport viewport{ (float)swapchainDimensions.x, (float)swapchainDimensions.y };
		Graphics::RHIScissorRect scissorRect{ swapchainDimensions.x, swapchainDimensions.y };
