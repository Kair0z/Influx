...
namespace influx::graphics
{
	...
	class dx12_depth_stencil_view 
		: public depth_stencil_view
		, public dx12_base
	{
	public:
	...
	class dx12_vertex_buffer_view 
		: public vertex_buffer_view
		, public dx12_base
	{
	public:
	...
	class dx12_index_buffer_view 
		: public index_buffer_view
		, public dx12_base
	{
	public:
	...
	class dx12_shader_resource_view 
		: public shader_resource_view
		, public dx12_base
	{
	public:
