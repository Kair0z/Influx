...
namespace influx::renderer
{
	...
	constexpr static uint8 k_num_swapchain_buffers_def = static_cast<uint8>(k_default_buffering);

	// threading
	constexpr static uint8 k_num_inflight_max = k_default_num_swapchain_buffers;
