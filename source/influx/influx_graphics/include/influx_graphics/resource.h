...
namespace influx::graphics
{
	...
	public:
		...
		inline e_resource_state get_resource_state() const { return get_state(); }
		...
		inline result<> transition(commandlist& cmdlist, e_resource_state new_state) { return transition(&cmdlist, new_state); }
