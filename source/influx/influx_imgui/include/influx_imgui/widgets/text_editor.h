...
namespace influx::imgui
{
	...
	inline bool equals(InputIt1 first1, InputIt1 last1,
	...
	inline void TextEditor::SetLanguageDefinition(const LanguageDefinition& aLanguageDef)
	{
	...
	inline void TextEditor::SetPalette(const Palette& aValue)
	{
		mPaletteBase = aValue;
	}

	inline std::string TextEditor::GetText(const Coordinates& aStart, const Coordinates& aEnd) const
	{
		std::string result;
	...
	inline TextEditor::Coordinates TextEditor::GetActualCursorCoordinates() const
	{
		return SanitizeCoordinates(mState.mCursorPosition);
	}

	inline TextEditor::Coordinates TextEditor::SanitizeCoordinates(const Coordinates& aValue) const
	{
	...
	inline static int UTF8CharLength(TextEditor::Char c)
	{
		if ((c & 0xFE) == 0xFC)
			return 6;
		if ((c & 0xFC) == 0xF8)
	...
	inline static int ImTextCharToUtf8(char* buf, int buf_size, unsigned int c)
	{
		if (c < 0x80)
		{
			buf[0] = (char)c;
	...
	inline void TextEditor::Advance(Coordinates& aCoordinates) const
	{
	...
	inline void TextEditor::DeleteRange(const Coordinates& aStart, const Coordinates& aEnd)
	{
		assert(aEnd >= aStart);
		assert(!mReadOnly);
	...
	inline int TextEditor::InsertTextAt(Coordinates& /* inout */ aWhere, const char* aValue)
	{
		assert(!mReadOnly);
	...
	inline void TextEditor::AddUndo(UndoRecord& aValue)
	{
		assert(!mReadOnly);
	...
	inline TextEditor::Coordinates TextEditor::ScreenPosToCoordinates(const ImVec2& aPosition) const
	{
	...
	inline TextEditor::Coordinates TextEditor::FindWordStart(const Coordinates& aFrom) const
	{
	...
	inline TextEditor::Coordinates TextEditor::FindWordEnd(const Coordinates& aFrom) const
	{
		Coordinates at = aFrom;
		if (at.mLine >= (int)mLines.size())
			return at;
	...
	inline TextEditor::Coordinates TextEditor::FindNextWord(const Coordinates& aFrom) const
	{
		Coordinates at = aFrom;
		if (at.mLine >= (int)mLines.size())
			return at;
	...
	inline int TextEditor::GetCharacterIndex(const Coordinates& aCoordinates) const
	{
	...
	inline int TextEditor::GetCharacterColumn(int aLine, int aIndex) const
	{
	...
	inline int TextEditor::GetLineCharacterCount(int aLine) const
	{
		if (aLine >= mLines.size())
			return 0;
		auto& line = mLines[aLine];
	...
	inline int TextEditor::GetLineMaxColumn(int aLine) const
	{
		if (aLine >= mLines.size())
			return 0;
		auto& line = mLines[aLine];
	...
	inline bool TextEditor::IsOnWordBoundary(const Coordinates& aAt) const
	{
	...
	inline void TextEditor::RemoveLine(int aStart, int aEnd)
	{
		assert(!mReadOnly);
		assert(aEnd >= aStart);
	...
	inline void TextEditor::RemoveLine(int aIndex)
	{
		assert(!mReadOnly);
	...
	inline TextEditor::Line& TextEditor::InsertLine(int aIndex)
	{
		assert(!mReadOnly);
	...
	inline std::string TextEditor::GetWordUnderCursor() const
	{
		auto c = GetCursorPosition();
		return GetWordAt(c);
	}

	inline std::string TextEditor::GetWordAt(const Coordinates& aCoords) const
	{
	...
	inline ImU32 TextEditor::GetGlyphColor(const Glyph& aGlyph) const
	{
		if (!mColorizerEnabled)
	...
	inline void TextEditor::HandleKeyboardInputs()
	{
	...
	inline void TextEditor::HandleMouseInputs()
	{
		ImGuiIO& io = ImGui::GetIO();
		auto shift = io.KeyShift;
		auto ctrl = io.ConfigMacOSXBehaviors ? io.KeySuper : io.KeyCtrl;
	...
	inline void TextEditor::Render(const char* aTitle, const ImVec2& aSize, bool aBorder)
	{
		mWithinRender = true;
		mTextChanged = false;
		mCursorPositionChanged = false;
	...
	inline void TextEditor::SetText(const std::string& aText)
	{
		mLines.clear();
	...
	inline void TextEditor::SetTextLines(const std::vector<std::string>& aLines)
	{
		mLines.clear();
	...
	inline void TextEditor::EnterCharacter(ImWchar aChar, bool aShift)
	{
		assert(!mReadOnly);
	...
	inline void TextEditor::SetReadOnly(bool aValue)
	{
		mReadOnly = aValue;
	}

	inline void TextEditor::SetColorizerEnable(bool aValue)
	{
		mColorizerEnabled = aValue;
	}

	inline void TextEditor::SetCursorPosition(const Coordinates& aPosition)
	{
	...
	inline void TextEditor::SetSelectionStart(const Coordinates& aPosition)
	{
	...
	inline void TextEditor::SetSelectionEnd(const Coordinates& aPosition)
	{
	...
	inline void TextEditor::SetSelection(const Coordinates& aStart, const Coordinates& aEnd, SelectionMode aMode)
	{
	...
	inline void TextEditor::SetTabSize(int aValue)
	{
		mTabSize = std::max(0, std::min(32, aValue));
	}

	inline void TextEditor::InsertText(const std::string& aValue)
	{
		InsertText(aValue.c_str());
	}

	inline void TextEditor::InsertText(const char* aValue)
	{
		if (aValue == nullptr)
			return;
	...
	inline void TextEditor::DeleteSelection()
	{
	...
	inline void TextEditor::MoveUp(int aAmount, bool aSelect)
	{
	...
	inline void TextEditor::MoveDown(int aAmount, bool aSelect)
	{
	...
	inline void TextEditor::MoveLeft(int aAmount, bool aSelect, bool aWordMode)
	{
		if (mLines.empty())
			return;
	...
	inline void TextEditor::MoveRight(int aAmount, bool aSelect, bool aWordMode)
	{
		auto oldPos = mState.mCursorPosition;
	...
	inline void TextEditor::MoveTop(bool aSelect)
	{
		auto oldPos = mState.mCursorPosition;
	...
	inline void TextEditor::TextEditor::MoveBottom(bool aSelect)
	{
	...
	inline void TextEditor::MoveHome(bool aSelect)
	{
		auto oldPos = mState.mCursorPosition;
	...
	inline void TextEditor::MoveEnd(bool aSelect)
	{
		auto oldPos = mState.mCursorPosition;
	...
	inline void TextEditor::Backspace()
	{
		assert(!mReadOnly);
	...
	inline void TextEditor::SelectWordUnderCursor()
	{
		auto c = GetCursorPosition();
		SetSelection(FindWordStart(c), FindWordEnd(c));
	}

	inline void TextEditor::SelectAll()
	{
		SetSelection(Coordinates(0, 0), Coordinates((int)mLines.size(), 0));
	}

	inline bool TextEditor::HasSelection() const
	{
		return mState.mSelectionEnd > mState.mSelectionStart;
	}

	inline void TextEditor::Copy()
	{
		if (HasSelection())
		{
	...
	inline bool TextEditor::CanUndo() const
	{
		return !mReadOnly && mUndoIndex > 0;
	}

	inline bool TextEditor::CanRedo() const
	{
		return !mReadOnly && mUndoIndex < (int)mUndoBuffer.size();
	}

	inline void TextEditor::Undo(int aSteps)
	{
		while (CanUndo() && aSteps-- > 0)
			mUndoBuffer[--mUndoIndex].Undo(this);
	}

	inline void TextEditor::Redo(int aSteps)
	{
		while (CanRedo() && aSteps-- > 0)
			mUndoBuffer[mUndoIndex++].Redo(this);
	}

	inline const TextEditor::Palette& TextEditor::GetDarkPalette()
	{
	...
	inline const TextEditor::Palette& TextEditor::GetLightPalette()
	{
		const static Palette p = { {
				0xff7f7f7f,	// None
				0xffff0c06,	// Keyword	
	...
	inline const TextEditor::Palette& TextEditor::GetRetroBluePalette()
	{
		const static Palette p = { {
				0xff00ffff,	// None
				0xffffff00,	// Keyword	
	...
	inline std::string TextEditor::GetText() const
	{
		return GetText(Coordinates(), Coordinates((int)mLines.size(), 0));
	}

	inline std::vector<std::string> TextEditor::GetTextLines() const
	{
	...
	inline std::string TextEditor::GetSelectedText() const
	{
		return GetText(mState.mSelectionStart, mState.mSelectionEnd);
	}

	inline std::string TextEditor::GetCurrentLineText()const
	{
	...
	inline void TextEditor::ProcessInputs()
	{
	}

	inline void TextEditor::Colorize(int aFromLine, int aLines)
	{
	...
	inline void TextEditor::ColorizeRange(int aFromLine, int aToLine)
	{
	...
	inline void TextEditor::ColorizeInternal()
	{
	...
	inline float TextEditor::TextDistanceToLineStart(const Coordinates& aFrom) const
	{
	...
	inline void TextEditor::EnsureCursorVisible()
	{
		if (!mWithinRender)
		{
	...
	inline int TextEditor::GetPageSize() const
	{
		auto height = ImGui::GetWindowHeight() - 20.0f;
		return (int)floor(height / mCharAdvance.y);
	}

	inline TextEditor::UndoRecord::UndoRecord(
		const std::string& aAdded,
		const TextEditor::Coordinates aAddedStart,
		const TextEditor::Coordinates aAddedEnd,
		const std::string& aRemoved,
	...
	inline void TextEditor::UndoRecord::Undo(TextEditor* aEditor)
	{
		if (!mAdded.empty())
		{
	...
	inline void TextEditor::UndoRecord::Redo(TextEditor* aEditor)
	{
		if (!mRemoved.empty())
		{
	...
	inline static bool TokenizeCStyleString(const char* in_begin, const char* in_end, const char*& out_begin, const char*& out_end)
	{
	...
	inline static bool TokenizeCStyleCharacterLiteral(const char* in_begin, const char* in_end, const char*& out_begin, const char*& out_end)
	{
		const char* p = in_begin;
	...
	inline static bool TokenizeCStyleIdentifier(const char* in_begin, const char* in_end, const char*& out_begin, const char*& out_end)
	{
		const char* p = in_begin;
	...
	inline static bool TokenizeCStyleNumber(const char* in_begin, const char* in_end, const char*& out_begin, const char*& out_end)
	{
		const char* p = in_begin;
	...
	inline static bool TokenizeCStylePunctuation(const char* in_begin, const char* in_end, const char*& out_begin, const char*& out_end)
	{
		(void)in_end;
	...
	inline const TextEditor::LanguageDefinition& TextEditor::LanguageDefinition::CPlusPlus()
	{
	...
	inline const TextEditor::LanguageDefinition& TextEditor::LanguageDefinition::HLSL()
	{
		static bool inited = false;
		static LanguageDefinition langDef;
		if (!inited)
	...
	inline const TextEditor::LanguageDefinition& TextEditor::LanguageDefinition::GLSL()
	{
		static bool inited = false;
		static LanguageDefinition langDef;
		if (!inited)
	...
	inline const TextEditor::LanguageDefinition& TextEditor::LanguageDefinition::C()
	{
		static bool inited = false;
		static LanguageDefinition langDef;
		if (!inited)
	...
	inline const TextEditor::LanguageDefinition& TextEditor::LanguageDefinition::SQL()
	{
		static bool inited = false;
		static LanguageDefinition langDef;
		if (!inited)
	...
	inline const TextEditor::LanguageDefinition& TextEditor::LanguageDefinition::AngelScript()
	{
		static bool inited = false;
		static LanguageDefinition langDef;
		if (!inited)
	...
	inline const TextEditor::LanguageDefinition& TextEditor::LanguageDefinition::Lua()
	{
		static bool inited = false;
		static LanguageDefinition langDef;
		if (!inited)
