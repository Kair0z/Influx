...
struct gbuffer
{
    ...
    uint normal_depth           : SV_TARGET1; // rg8  x 1 = 16/32bit
...
{
    uint r = (uint)(v.x * 1023.0) & 0x3FF; // 10-bit
    uint g = (uint)(v.y * 1023.0) & 0x3FF; // 10-bit
    uint b = (uint)(v.z * 1023.0) & 0x3FF; // 10-bit
